package me.catto.autogg.handlers.gg;

import me.catto.autogg.AutoGG;
import me.catto.autogg.handlers.patterns.PatternHandler;
import me.catto.autogg.tasks.data.Server;
import me.catto.autogg.tasks.data.Trigger;
...
import static me.catto.autogg.AutoGG.obs;
...
public class AutoGGHandler {
    ...
    public void onClientChatReceived(ClientChatReceivedEvent event) {
        ...
        if(stripped.contains("Eliminate your opponents!")) {
            obs.startRecording();
            AutoGG.logger.info("");
        }
    }

    private void invokeGG() throws InterruptedException {
        ...
        Multithreading.runAsync(() -> {
            try {
                Thread.sleep(AutoGG.INSTANCE.getAutoGGConfig().getAutoOBSDelay()*1000);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
            obs.stopRecording();
